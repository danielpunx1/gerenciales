...
<div id="contenidoR">
    ...
    <form name="form" id="expediente" action="reporte1A_grafico.php" method="POST">
        ...
        <div id='contenido3R'></div>
            ...
            <table class='tablam tablaFrmEst'>
                <tr>
                    ...
                    <td>
                        <SELECT size="1" NAME="materia" style="width: 250;">
                            <OPTION VALUE="CAC" SELECTED>Civil</OPTION>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" NAME="juicio" maxlength="60" onkeypress="return solo_letras(event)" style="width: 250;" placeholder="ingrese un tipo de juicio" />
                    </td>
                </tr>
                <tr>
                    <td>Desde:</td>
                    <td>
                        <input type="text" NAME="desde" id="desde" maxlength="10" readonly style="width: 250;" title="Fecha de inicio para la busqueda"/>
                    </td>
                </tr>
                <tr>
                    <td>Hasta:</td>
                    <td>
                        <input type="text" NAME="hasta" id="hasta" maxlength="10" readonly style="width: 250;" title="Fecha de fin para la busqueda"/>
                    </td>
                </tr>
            </table>
