...
function modificar_usuario(usuario)
{
	...
	xmlhttp.open("GET","baja_usuario_ajax.php?usuario="+usuario,true);
	xmlhttp.send();
}
</script>
...
<div id="contenedor">
     ...
     <div id="contenido">
	    <form name="nuevo-usuario" action="baja_usuario_baja.php" method="post">
	     	<fieldset>
		     	<table class="formulario" cellpadding="0" cellspacing="0" border="0">
		     		...
		     		<tr>
		     			<td class="caja1" style="width:115px;">Seleccione usuario</td>
		     			<td class="caja3">
		     				<select name="user_mod" onchange="modificar_usuario(this.value)">
		     	...
		     	<div id="datos_modificar">
		     		...
		     		<table class="formulario" cellpadding="0" cellspacing="0" border="0">
			     		...
			     		<tr>
			     			<td class="caja4" colspan="4"> <input type="submit" name="Guardar" disabled="disabled" value="Desactivar usuario"> </td>
			     		</tr>
			     	</table>
		     	</div>
