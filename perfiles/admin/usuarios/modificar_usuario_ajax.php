	...
	?>
						<table class="formulario" cellpadding="0" cellspacing="0" border="0">
			     		<tr>
			     		    ...
			     		    <td class="caja2"> <input type="text" name="nick" <?php echo 'value="'.$filas['nick'].'"'; ?> maxlength="18" /> </td>
			     		    <td class="caja1"> Contrase&ntilde;a : </td>
			     		    <td class="caja2"> <input type="password" placeholder='Digitar contrase&ntilde;a solo si desea modificar' name="pass" value="" onclick="alert('Dejar el campo en blanco si NO desea modificar su password actual PERO si desea modificarlo por favor ingrese su NUEVO password');" maxlength="18"> </td>
			     		</tr>

			     		<tr>
			     			<td class="caja1"> Nombres : </td>
			     			<td class="caja2"> <input type="text" name="nombres" <?php echo 'value="'.$filas['nombres'].'"'; ?> onkeypress="return solo_letras(event)" maxlength="50"> </td>
			     			<td class="caja1"> Apellidos : </td>
			     			<td class="caja2"> <input type="text" name="apellidos" <?php echo 'value="'.$filas['apellidos'].'"'; ?> onkeypress="return solo_letras(event)" maxlength="50"> </td>
			     		</tr>

			     		<tr>
			     			<td class="caja1">Acceso : </td>
			     			<td class="caja3" colspan="3">
			     				<input type="radio" name="acceso" <?php if($filas['acceso']==1){ echo 'checked="checked"'; } ?> value="1" > Administrador
			     				<input type="radio" name="acceso" <?php if($filas['acceso']==2){ echo 'checked="checked"'; } ?> value="2" > Usuario Estrategico
			     				<input type="radio" name="acceso" <?php if($filas['acceso']==3){ echo 'checked="checked"'; } ?> value="3" > Usuario Tactico
			     			</td>
			     		</tr>

			     		<tr>
			     			<td class="caja4" colspan="4"> <input type="submit" name="Guardar" value="Modificar usuario"> </td>
			     		</tr>
			     	</table>
