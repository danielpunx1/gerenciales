...
function modificar_usuario(usuario)
{
	...
	xmlhttp.open("GET","alta_usuario_ajax.php?usuario="+usuario,true);
	xmlhttp.send();
}
</script>
	    ...
	    <form name="nuevo-usuario" action="baja_usuario_baja.php" method="post">
	     	<fieldset>
		     	<table class="formulario" cellpadding="0" cellspacing="0" border="0">
		     		...
		     		<tr>
		     			<td class="caja1" style="width:115px;">Seleccionar usuario</td>
		     			<td class="caja3">
		     				<select name="user_mod" onchange="modificar_usuario(this.value)">
		     					<option value="">Seleccione un usuario</option>
		     					<?php

		     					    $sql ="SELECT nick FROM login WHERE fecha_baja IS NOT NULL";
