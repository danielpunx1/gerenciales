...
// ==================================================================
			...
			class Paginator_html4 extends Paginator { 
			 ...
			 if($this->getCurrent()==1)
		         {
		         $first = "Primero | ";
		         } else { $first="<a href=\"" . $this->getPageName() ."?col=".$this->getGet1()."&mat=".$this->getGet4()."&page=" . $this->getFirst() . "\">Primero</a> |"; }  

		         if($this->getPrevious())
		         {
		         $prev = "<a href=\"" . $this->getPageName() ."?col=".$this->getGet1()."&mat=".$this->getGet4()."&page=" . $this->getPrevious() . "\">Anterior</a> | ";
		         } else { $prev="Anterior | "; }
		
		         if($this->getNext())
		         {
		         $next = "<a href=\"" . $this->getPageName() ."?col=".$this->getGet1()."&mat=".$this->getGet4()."&page=" . $this->getNext() . "\">Siguiente</a> | ";
		         } else { $next="Siguiente | "; }
				
		         if($this->getLast())
		         {
		         $last = "<a href=\"" . $this->getPageName() ."?col=".$this->getGet1()."&mat=".$this->getGet4()."&page=" . $this->getLast() . "\">&Uacute;ltimo</a>&nbsp;";
