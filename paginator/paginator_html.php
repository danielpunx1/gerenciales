...
// ==================================================================
			...
			class Paginator_html extends Paginator { 
			 ...
			 if($this->getCurrent()==1)
		         {
		         $first = "Primero | ";
		         } else { $first="<a href=\"" . $this->getPageName() ."?colaborador=".$this->getGet1()."&asignacion=".$this->getGet2()."&tipo=".$this->getGet3()."&materia=".$this->getGet4()."&desde=".$this->getGet5()."&hasta=".$this->getGet6()."&page=" . $this->getFirst() . "\">Primero</a> |"; }  

		         if($this->getPrevious())
		         {
		         $prev = "<a href=\"" . $this->getPageName() ."?colaborador=".$this->getGet1()."&asignacion=".$this->getGet2()."&tipo=".$this->getGet3()."&materia=".$this->getGet4()."&desde=".$this->getGet5()."&hasta=".$this->getGet6()."&page=" . $this->getPrevious() . "\">Anterior</a> | ";
		         } else { $prev="Anterior | "; }
		
		         if($this->getNext())
		         {
		         $next = "<a href=\"" . $this->getPageName() ."?colaborador=".$this->getGet1()."&asignacion=".$this->getGet2()."&tipo=".$this->getGet3()."&materia=".$this->getGet4()."&desde=".$this->getGet5()."&hasta=".$this->getGet6()."&page=" . $this->getNext() . "\">Siguiente</a> | ";
		         } else { $next="Siguiente | "; }
				
		         if($this->getLast())
		         {
		         $last = "<a href=\"" . $this->getPageName() ."?colaborador=".$this->getGet1()."&asignacion=".$this->getGet2()."&tipo=".$this->getGet3()."&materia=".$this->getGet4()."&desde=".$this->getGet5()."&hasta=".$this->getGet6()."&page=" . $this->getLast() . "\">&Uacute;ltimo</a>&nbsp;";
